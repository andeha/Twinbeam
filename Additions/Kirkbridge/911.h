...
enum { 𝘇𝗲𝗿𝗼₋, 𝘇𝗲𝗿𝗼₊, 𝗿𝟭, 𝗿𝟮, 𝗿𝟯, 𝗿𝟰, 𝗿𝟱, 𝗿𝟲, 𝗿𝗮𝘅, 𝗰𝘀𝟬, 𝗰𝘀𝟭, 𝗰𝘀𝟮, 𝗰𝘀𝟯, 𝗮𝗰𝗰𝟯𝗵𝗶, 
  𝗮𝗰𝗰𝟯𝗹𝗼, 𝗮𝗰𝗰𝟮𝗵𝗶, 𝗮𝗰𝗰𝟮𝗹𝗼, 𝗮𝗰𝗰𝟭𝗵𝗶, 𝗮𝗰𝗰𝟭𝗹𝗼, 𝗮𝗰𝗰𝟬𝗵𝗶, 𝗮𝗰𝗰𝟬𝗹𝗼, 𝗻𝗲𝘃𝗲𝗿 };
...
extern void (^𝘀𝗶𝗴𝗻𝗲𝘅𝘁𝗼)(gpr r, 𝗚𝗿𝗮𝗻𝘂𝗹 from, 𝗚𝗿𝗮𝗻𝘂𝗹 to, void (^overflow)(void *) /* = parallel₋µProc::nothing𝘖rNull. */);
extern void (^𝖻𝗋𝖺𝗇𝖼𝗁)(gpr r₁, gpr r₂, int16_t offset, 𝗦𝗼𝗿𝘁 𝗧, 𝗗𝗶𝗳𝗳𝗲𝗿𝗲𝗻𝘁 f, 𝗚𝗿𝗮𝗻𝘂𝗹 g); /* Operation follows by /off₋set/. */
extern void (^𝖭𝗈𝗐)(vaddr absolute); /* ⬷ Dereferences application base and one tetra. */
extern void (^𝗌𝗂𝗆𝖽₋𝗂𝗇𝗂𝗍₁₆)(uint8_t eightbits, gpr r₌); /* ⬷ 𝘊․𝘧 𝗌𝗂𝗆𝖽₋𝗂𝗇𝗂𝗍₈, 𝗌𝗂𝗆𝖽₋𝗂𝗇𝗂𝗍₄, 𝗌𝗂𝗆𝖽₋𝗂𝗇𝗂𝗍₂. */
...
extern void (^𝖿𝗆𝖺₋𝚄ℚ𝟽)(gpr r₁, gpr r₂, gpr r₌, void (^raise₋carry)(void *) /* = µProcᵖ::nothing𝘖rNull */); /* 0 ≤ x ≤ (2ⁿ - 1)/2ⁿ */
...
extern void (^𝗇𝖾𝗀𝖺𝗍𝖾)(gpr r, gpr neg, 𝗚𝗿𝗮𝗻𝘂𝗹 g, gpr r₌); /* ⬷ alternates sign. */
extern void (^𝖺𝖽𝖽)(gpr 𝚛₁, gpr 𝚛₂, gpr r₌, 𝗦𝗼𝗿𝘁 s, 𝗚𝗿𝗮𝗻𝘂𝗹 g, void (^carry𝘖rOverflow)(void *) /* = µProcᵖ::nothing𝘖rNull */);
extern void (^𝗌𝗎𝖻)(gpr 𝚛₁, gpr 𝚛₂, gpr r₌, 𝗦𝗼𝗿𝘁 s, 𝗚𝗿𝗮𝗻𝘂𝗹 g, void (^carry𝘖rOverflow)(void *) /* = µProcᵖ::nothing𝘖rNull */);
...
extern void (^𝗌𝗇𝖺𝗉𝗌𝗁𝗈𝗍)(gpr r₋loc); /* Registers, context ∨ debug: 𝚝𝚊𝚙_𝚘𝚗 */
