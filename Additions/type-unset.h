...
namespace Composingstick {
   ...
   MACRO Intervallic clear(Intervallic substractive, Directions::Cross reading₋mass, 
...
EXT₋C int Render(doubleʳ t, Bezier c, void (^stream)(simd_tᵦ xy, simd_tᵦ color, 
 simd_tᵦ p₋₁OrΨΛΩ));
