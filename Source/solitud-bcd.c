...
inexorable void zero₋justify(𝓵₋bigint * z)
{
...
{ char *p,c; int length=sevenbit₋strlen(digits);
   bcd₋bigint₋zero(0,z);
again:
   c = *(i+digits-length);
