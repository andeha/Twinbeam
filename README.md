...
To use the library, include the Twinbeam.h header and link with its corresponding libTwinbeam_PIC32MZ or libTwinbeam_macOS archive.
...
The bootloader expects the interrupt service routine to start on the virtual address 0xBD000000 and that the __start symbol is placed on 0xBD001000.