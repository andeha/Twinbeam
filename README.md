...
Requires [`ninja`](https://ninja-build.org), [`llvm`](https://llvm.org) and — for MIPS development — a pic32mz development board. Also [Knot.h](https://raw.githubusercontent.com/wiki/andeha/Twinbeam/PDFs/Knot.🔥.h.pdf).
