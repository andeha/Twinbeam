...
int Reflect(Unicodes pathᵚᵍ, __builtin_int_t pagesOffset, __builtin_int_t 
  pagesLength, int (^transformAndResolve)(Unicodes pathᵚᵍ, void (^final)(
  const char * regular𝘖rLinkpath)), Scatter &region, /* bool no₋writes, */ bool append𝙴𝙾𝚃at𝙴𝙾𝙵);
